...
//QS:17
sessionStorage.setItem('cool_scret',123) //ReferenceError: sessionStorage is not defined
...
console.log(sayHi.call(person,21)) // Gobinda is 21
console.log(sayHi.bind(person,21)()) // Gobinda is 21
...
const numbers=[1,2,3];
numbers[4]=numbers;
console.log(numbers) //[ 1, 2, 3, <1 empty item>, [Circular *1] ]
